...
SECRET_KEY = 'django-insecure-w9^8rq*p4#6-xq+oj6i_r1i9!+6s_ho1y%1=qm=0g@xq*rz6ac'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://127.0.0.1",  # If testing locally
    "http://localhost",
]
...
AUTHENTICATION_BACKENDS = [
    'authentications.authentication.EmailBackend',  #  custom backend
